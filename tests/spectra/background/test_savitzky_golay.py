...
from spectrumlab.backgrounds.savitzky_golay_background import SavitzkyGolayBackgroundConfig
from spectrumlab.backgrounds.savitzky_golay_background import approximate_savitzky_golay
