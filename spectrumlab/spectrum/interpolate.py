...
from spectrumlab.emulations.curves import lanczos
...
def interpolate_lanczos(x_grid: Array[float], y_grid: Array[float], a: int = 3) -> Array[float]:
...
def interpolate(x: Array[float], y: Array[float], offset: float, kind: InterpolationKind = InterpolationKind.LINEAR) -> Array[float]:
